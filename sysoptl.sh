...
function start_service() {
    ...
    systemctl start "$1"
    echo "Service $1 has been started."
}
...
function stop_service() {
    ...
    systemctl stop "$1"
    echo "Service $1 has been stopped."
}

# Show current system load averages
function system_load() {
    echo "Displaying current system load averages..."
    uptime
}
...
function monitor_processes() {
    echo "Monitoring system processes. Press 'q' to exit."
    top
}
